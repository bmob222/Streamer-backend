...
struct VideovardResolver: Resolver {
    ...
    func getMediaURL(url: URL) async throws -> [Stream] {
        ...
        guard let url = URL(string: fileAsset) else {
            throw VideovardResolverError.urlNotValid
        }
        ...
        return [.init(Resolver: "Videovard", streamURL: url, subtitles: subtitles)]
    }

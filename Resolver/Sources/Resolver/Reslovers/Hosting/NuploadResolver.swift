...
struct NuploadResolver: Resolver {
    let name = "Nupload"
    static let domains: [String] = ["nupload.xyz", "nupload.co", "nuuuppp.online", "nuuuppp.xyz", "nuuuppp.pics"]
    ...
    func getMediaURL(url: URL) async throws -> [Stream] {
        ...
        return [.init(Resolver: "NupLoad", streamURL: streamURL,
                      headers: [

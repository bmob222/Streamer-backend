...
struct HiAnimeReslover: Resolver {
    let name = "HiAnime"
    static let domains: [String] = ["hianime.to"]
    private let baseURL: URL = URL(staticString: "https://hianime.to")

    func canHandle(url: URL) -> Bool {
        Self.domains.firstIndex(of: url.host!) != nil || url.host?.contains("hianime") == true
    }

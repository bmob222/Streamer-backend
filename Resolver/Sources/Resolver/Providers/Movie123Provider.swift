...
public struct Movie123Provider: Provider {
    ...
    public let baseURL: URL = URL(staticString: "https://123moviesfree.so/")
    public var moviesURL: URL {
        baseURL.appendingPathComponent("movie/filter/movie/all/all/all/all/latest/")
    }
    ...
    private var homeURL: URL {
        baseURL.appendingPathComponent("123movies")
    }

    private let subtitleBaseURL = URL(staticString: "https://sub.movie-series.net")

    private enum Movie123ProviderError: Error {

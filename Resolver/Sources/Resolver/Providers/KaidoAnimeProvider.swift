...
public class KaidoAnimeProvider: Provider {
    ...
    public let baseURL: URL = URL(staticString: "https://kaido.to")
    ...
    public func fetchTVShowDetails(for url: URL) async throws -> TVshow {
        ...
        let episodes = try rows.array().map { row -> Episode in
            ...
            let url = self.baseURL.appendingPathComponent("ajax/episode/servers")
    ...
    public func home() async throws -> [MediaContentSection] {
        ...
        let recommendedTVShows = MediaContentSection(title: NSLocalizedString("New On Kaido", comment: ""),
                                                     media: Array(items.prefix(12)))
...
private extension KaidoAnimeProvider {
    ...
    private func parsePageContent(_ content: String) throws -> [MediaContent] {
        ...
        let watchBaseURL = URL(staticString: "https://kaido.to/watch")
